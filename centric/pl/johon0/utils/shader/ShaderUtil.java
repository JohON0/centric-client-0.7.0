...
import centric.pl.johon0.utils.shader.exception.UndefinedShader;
...
public class ShaderUtil implements IMinecraft {
    ...
    public static ShaderUtil faceRound = new ShaderUtil("roundedface");
    ...
    public ShaderUtil(String fragmentShaderLoc) {
        ...
        try {
            ...
            int fragmentShaderID = switch (fragmentShaderLoc) {
                ...
                case "roundedface" -> createShader(Shaders.getInstance().getROUND_FACE(), GL_FRAGMENT_SHADER);
