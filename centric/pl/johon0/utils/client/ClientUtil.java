package centric.pl.johon0.utils.client;
...
public class ClientUtil implements IMinecraft {
    ...
    public synchronized void playSound(String sound, float value, boolean nonstop) {
        ...
        try {
            ...
            InputStream is = mc.getResourceManager().getResource(new ResourceLocation("centric/sounds/" + sound + ".wav")).getInputStream();
            ...
            currentClip.start();
            FloatControl floatControl = (FloatControl) currentClip.getControl(FloatControl.Type.PAN);
