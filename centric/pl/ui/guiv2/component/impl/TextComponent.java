...
public class TextComponent extends Component {
    ...
    public void drawComponent(MatrixStack matrixStack, int mouseX, int mouseY) {
        ...
        float width = Fonts.roboto[14].getWidth(text) + 4;
        ...
        Fonts.roboto[14].drawCenteredString(matrixStack, text, x + 5 + (width / 2), y + 6, -1);
        Fonts.roboto[14].drawString(matrixStack, setting.getName(), x + 5 + width + 3, y + 6, -1);
    }
