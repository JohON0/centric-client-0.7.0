...
import centric.pl.events.impl.EventDamageReceive;
import centric.pl.events.impl.JumpEvent;
import centric.pl.functions.api.FunctionRegistry;
//import centric.pl.functions.impl.combat.KillAura;
import centric.pl.functions.impl.misc.AntiPush;
import centric.pl.functions.impl.render.SwingAnimation;
...
public abstract class LivingEntity extends Entity {
    ...
    public boolean canAttack() {
        ...
        return this.canBeAttackedWithItem() && !this.isInvulnerable();
    }
    ...
    protected void jump() {
        ...
        if (this instanceof ClientPlayerEntity entity) {
            Main.getInstance().getEventBus().post(jumpEvent);
        }
    ...
    public void travel(Vector3d travelVector) {
        if (this.isServerWorld() || this.canPassengerSteer()) {
            ...
            if (this.isInWater() && this.func_241208_cS_() && !this.func_230285_a_(fluidstate.getFluid())) {
                ...
                if (killAura.isState() && killAura.getOptions().getValueByName("Коррекция движения").get() && this instanceof ClientPlayerEntity) {
