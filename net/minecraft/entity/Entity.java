...
import centric.pl.events.impl.PostMoveEvent;
import centric.pl.functions.api.FunctionRegistry;
import centric.pl.functions.impl.combat.Hitbox;
import centric.pl.functions.impl.render.Trails;
...
public abstract class Entity implements INameable, ICommandSource {
    ...
    public void move(MoverType typeIn, Vector3d pos) {
        ...
        if (this.noClip) {
            ...
            if (this instanceof ClientPlayerEntity) {
                ...
                Main.getInstance().getEventBus().post(move);
            ...
            if (this instanceof ClientPlayerEntity) {
                ...
                Main.getInstance().getEventBus().post(post);
            }
    ...
    public boolean startRiding(Entity entityIn, boolean force) {
        Main.getInstance().getEventBus().post(new EventStartRiding(entityIn));
