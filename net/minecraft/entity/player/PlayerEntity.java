...
import centric.pl.functions.impl.player.AutoTool;
...
public abstract class PlayerEntity extends LivingEntity {
    ...
    @Override
    public void tick() {
        this.noClip = this.isSpectator() || Main.getInstance().getFunctionRegistry().getFreeCam().isState();
    ...
    public boolean func_234569_d_(BlockState p_234569_1_) {
        AutoTool autoTool = Main.getInstance().getFunctionRegistry().getAutoTool();
