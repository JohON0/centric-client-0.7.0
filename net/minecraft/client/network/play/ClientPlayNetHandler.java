...
import centric.pl.functions.impl.player.NoRotate;
    ...
    public void onDisconnect(ITextComponent reason) {
        ...
        if (this.guiScreenServer != null) {
            ...
            this.client.displayGuiScreen(
                    new DisconnectedScreen(new MultiplayerScreen(selfDestruct.enabled ? new MainMenuScreen() : new MainScreen()), field_243491_b, reason));
        }
    }
