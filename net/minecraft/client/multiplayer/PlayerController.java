...
import centric.pl.events.impl.WindowClickEvent;
import centric.pl.functions.api.FunctionRegistry;
//import centric.pl.functions.impl.combat.KillAura;
import centric.pl.functions.impl.player.NoInteract;
...
public class PlayerController {
     ...
     */
    public ItemStack traceableWindowClick(int windowId, int slotId, int mouseButton, ClickType type, PlayerEntity player) {
        Main.getInstance().getEventBus().post(new WindowClickEvent(windowId, slotId, mouseButton, type, WindowClickEvent.Type.PRE));
        ...
        Main.getInstance().getEventBus().post(new WindowClickEvent(windowId, slotId, mouseButton, type, WindowClickEvent.Type.POST));
        return itemstack;
    }
