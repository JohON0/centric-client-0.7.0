...
public class ResourceLoadProgressGui extends LoadingGui
{
    ...
    private static final String images ="centric/bg/" + "bg" + Main.image + ".png";
    private static final int field_238627_b_ = ColorHelper.PackedColor.packColor(255, 255, 255, 255);
...
//            fill(matrixStack, 0, 0, i, j, this.colorBackground | l << 24);
            DisplayUtils.drawImage(new ResourceLocation(images),0, 0, i, j,this.colorBackground | l << 24);
...
//            fill(matrixStack, 0, 0, i, j, this.colorBackground | i2 << 24);
            DisplayUtils.drawImage(new ResourceLocation(images),0, 0, i, j,this.colorBackground | i2 << 24);
            f2 = MathHelper.clamp(f1, 0.0F, 1.0F);
        }
        else
        {
//            fill(matrixStack, 0, 0, i, j, this.colorBackground | -16777216);
            DisplayUtils.drawImage(new ResourceLocation(images),0, 0, i, j,this.colorBackground | -16777216);
            f2 = 1.0F;
        }
