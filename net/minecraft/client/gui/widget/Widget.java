...
public abstract class Widget extends AbstractGui implements IRenderable, IGuiEventListener {
    ...
    public void renderButton(MatrixStack matrixStack, int mouseX, int mouseY, float partialTicks) {
        ...
        HUD.drawStyledRect(this.x, this.y, this.width, this.height, 4);
        int color = (this.active && this.isHovered) ? ThemeSwitcher.textcolor : 10526880;
        Fonts.notoitalic[16].drawCenteredString(matrixStack, this.getMessage().getString(), this.x + this.width / 2, this.y + (this.height - 5) / 2, color | MathHelper.ceil(this.alpha * 255.0F) << 24);
