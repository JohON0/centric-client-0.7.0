...
public class MultiplayerScreen extends Screen {
    ...
    private final VersionSelectScreen viaScreen = Main.getInstance().getViaMCP().getViaScreen();
    ...
    protected void init() {
        ...
        if (!selfDestruct.enabled)
            addButton(Main.getInstance().getViaMCP().viaScreen);
    ...
    public void tick() {
        super.tick();
        Main.getInstance().getViaMCP().viaScreen.tick();
