...
public class ChatScreen extends Screen {
    ...
    protected void init() {
        ...
        if (!selfDestruct.enabled) {
            this.addButton(this.button = new Button(mainWindow.getScaledWidth() - 152, mainWindow.getScaledHeight() - 35, 150, 20, new StringTextComponent("Скрыть информацию: " + hide), (button) -> {
                hide = !hide;
            }));
