...
import centric.pl.events.impl.EventCalculateCooldown;
import centric.pl.events.impl.EventCooldown;
...
public class CooldownTracker {
    ...
    public float getCooldown(Item itemIn, float partialTicks) {
        ...
        Main.getInstance().getEventBus().post(cooldown);
        ...
        if (!this.cooldowns.isEmpty()) {
            ...
            while (iterator.hasNext()) {
                ...
                if ((entry.getValue()).expireTicks <= this.ticks) {
                    ...
                    Main.getInstance().getEventBus().post(eventCooldown);
                    iterator.remove();
