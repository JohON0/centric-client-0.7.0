...
public class AxisAlignedBB
{
    ...
    public Optional<Vector3d> raycast(Vector3d min, Vector3d max) {
    ...
    @Nullable
    private static Direction traceCollisionSide(AxisAlignedBB box, Vector3d intersectingVector, double[] traceDistanceResult, @Nullable Direction approachDirection, double deltaX, double deltaY, double deltaZ) {
        if (deltaX > 1.0E-7) {
